...
//
//        let button1 = UIBarButtonItem(image: UIImage(named: "menu"), style: .plain, target: self, action: #selector(ExampleNavigationController.btnSideMenu)) // action:#selector(Class.MethodName) for swift 3
